...
class VocabularyL2ViewModel(private val repo: VocabularyL2Repository): ViewModel() {
    private val _words = MutableStateFlow<List<VocabularyL2>>(emptyList())
    val words: StateFlow<List<VocabularyL2>> = _words
